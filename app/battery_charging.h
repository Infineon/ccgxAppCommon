...
#define BC_QC_AFC_SNK_MAX_CUR           (CY_PD_I_3A)  /**< BC QC AFC sink maximum current in 1mA units */
#endif /* BC_QC_AFC_SNK_MAX_CUR */
#ifndef BC_QC_AFC_SNK_MIN_CUR
#define BC_QC_AFC_SNK_MIN_CUR           (CY_PD_I_1P5A)  /**< BC QC AFC sink maximum current in 1mA units */
