...
/* CCG ECDSA: Highest Optimization level for Speed. */
...
/* CCG ECDSA: Faster method used for squaring. */
#ifndef uECC_SQUARE_FUNC
    #define uECC_SQUARE_FUNC 1
#endif

/* CCG ECDSA: Using Curve secp256r1.  */
...
/* Specifies   compressed point format is supported.
...
typedef uECC_Curve (*uECC_secp256r1_fptr)(void);
#endif
...
typedef void (*uECC_set_rng_fptr)(uECC_RNG_Function rng_function);
...
typedef int (*uECC_valid_public_key_fptr)(const uint8_t *public_key, uECC_Curve curve);
...
typedef int (*uECC_sign_fptr)(const uint8_t *private_key,
              const uint8_t *message_hash,
              unsigned hash_size,
              uint8_t *signature,
              uECC_Curve curve);
...
typedef int (*uECC_verify_fptr)(const uint8_t *public_key,
                const uint8_t *message_hash,
                unsigned hash_size,
                const uint8_t *signature,
                uECC_Curve curve);
