...
int mbedtls_rsa_pkcs1_verify( mbedtls_rsa_context *ctx,
                      ...
                      unsigned int hashlen,
                      const unsigned char *hash,
                      unsigned char *sig ); /* TAG: CY_CCG_Specific_Updates: Removed const */
...
bool verify_signature(uint8_t *fwct_sha, uint16_t fwct_sha_len, uint8_t *signature,
            uint16_t sign_len, uint8_t *public_key, uint16_t key_len);
typedef bool (*verify_signature_fptr)(uint8_t *fwct_sha, uint16_t fwct_sha_len, uint8_t *signature,
            uint16_t sign_len, uint8_t *public_key, uint16_t key_len);

void crypto_init_globals (void);
typedef void (*crypto_init_globals_fptr) (void);
