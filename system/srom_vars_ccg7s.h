...
#if (CCG_LOAD_SHARING_ENABLE  || CCG_BOOT)
...
typedef struct
{
    ...
    /* SCB */
    CySCB_Type *SCB_PRT[I2C_BLOCK_COUNT];
...
typedef struct
{
    ...
    void(*i2c_timer_cb)(cy_timer_id_t id, void *callbackContext);
...
#define call_Cy_SysLib_DelayUs(func)                CALL_OUT_FUNCTION(func)
#define call_Cy_SysInt_SetVector(func)              CALL_OUT_FUNCTION(func)
#define call___NVIC_EnableIRQ(func)                 CALL_OUT_FUNCTION(func)
#define call___NVIC_DisableIRQ(func)                CALL_OUT_FUNCTION(func)
#define call_Get_PdStack_Context(func)              CALL_OUT_FUNCTION(func)
...
#if SROM_CODE_HPISS_HPI
#define call_Cy_SysLib_EnterCriticalSection(func)               CALL_OUT_FUNCTION(func)
#define call_Cy_SysLib_ExitCriticalSection(func)                CALL_OUT_FUNCTION(func)
#define call_ccg_ls_is_enabled(func)                    CALL_OUT_FUNCTION(func)
#define call_ccg_power_throttle_get_feature_mask(func)  CALL_OUT_FUNCTION(func)
#define call_ccg_power_throttle_set_feature_mask(func)  CALL_OUT_FUNCTION(func)
#define call_ccg_power_throttle_set_oc_ec(func)         CALL_OUT_FUNCTION(func)
#define call_ccg_power_throttle_get_oc_ec(func)         CALL_OUT_FUNCTION(func)
#define call_ccg_power_throttle_get_oc(func)            CALL_OUT_FUNCTION(func)
#define call_vconn_enable(func)                         CALL_OUT_FUNCTION(func)
#define call_vconn_disable(func)                        CALL_OUT_FUNCTION(func)
#define call_ccg_power_throttle_get_oc(func)            CALL_OUT_FUNCTION(func)
#define call_vconn_is_present(func)                     CALL_OUT_FUNCTION(func)
#define call_ccg_ls_is_heart_beat_running(func)         CALL_OUT_FUNCTION(func)
#define call_ccg_power_throttle_get_port_budget(func)   CALL_OUT_FUNCTION(func)
#define call_Cy_PdStack_Dpm_IsPrevContractValid(func)   CALL_OUT_FUNCTION(func)
#define call_ccg_ls_ctrl(func)                          CALL_OUT_FUNCTION(func)
#define call_ccg_power_throttle_set_pdp(func)           CALL_OUT_FUNCTION(func)
#define call_ccg_power_throttle_set_pdp(func)           CALL_OUT_FUNCTION(func)
#define call_EC_INT_Write(func)                         CALL_OUT_FUNCTION(func)
#define call___NVIC_SystemReset(func)                   CALL_OUT_FUNCTION(func)
...
#define call_Cy_PdStack_Dpm_Stop(func)                  CALL_OUT_FUNCTION(func)
...
#define call_Cy_PdStack_Dpm_Start(func)                 CALL_OUT_FUNCTION(func)
#define call_app_disable_pd_port(func)                  CALL_OUT_FUNCTION(func)
...
#define call_ccg_power_throttle_get_set_config_oc(func) CALL_OUT_FUNCTION(func)
#endif /* SROM_CODE_HPISS_HPI */
