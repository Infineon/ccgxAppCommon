/******************************************************************************
* File Name: srom_vars_wlc1.h
* \version 2.0
*
* Description: Header file for WLC1 SROM code
*
...
#ifndef SROM_VARS_WLC1_H_
#define SROM_VARS_WLC1_H_
...
************************************************************************/
#if (defined(CY_DEVICE_SERIES_WLC1) && (CCG_SROM_CODE_ENABLE))
/** @cond DOXYGEN_HIDE */
typedef struct
{
    /* uECC variables */
...
#endif /* (defined(CY_DEVICE_SERIES_WLC1) && (CCG_SROM_CODE_ENABLE)) */
#endif /* SROM_VARS_WLC1_H_ */
